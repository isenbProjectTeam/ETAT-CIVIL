...
public class NaissanceResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_DATE_DECLARATION = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_DECLARATION = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void getAllNaissances() throws Exception {
        ...
        restNaissanceMockMvc.perform(get("/api/naissances?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateDeclaration").value(hasItem(sameInstant(DEFAULT_DATE_DECLARATION))));
    }
    ...
    public void getNaissance() throws Exception {
        ...
        restNaissanceMockMvc.perform(get("/api/naissances/{id}", naissance.getId()))
            ...
            .andExpect(jsonPath("$.dateDeclaration").value(sameInstant(DEFAULT_DATE_DECLARATION)));
    }
