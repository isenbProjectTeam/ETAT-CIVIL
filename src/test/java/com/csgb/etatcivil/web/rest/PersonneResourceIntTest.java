...
public class PersonneResourceIntTest {
    ...
    private static final Genre DEFAULT_GENRE = Genre.Feminin;
    private static final Genre UPDATED_GENRE = Genre.Masculin;
    ...
    public static Personne createEntity(EntityManager em) {
        ...
        // Add required entity
        Pays paysNaissance = PaysResourceIntTest.createEntity(em);
        em.persist(paysNaissance);
        em.flush();
        personne.setPaysNaissance(paysNaissance);
        // Add required entity
        Ville villeNaissance = VilleResourceIntTest.createEntity(em);
        em.persist(villeNaissance);
        em.flush();
        personne.setVilleNaissance(villeNaissance);
        return personne;
    }
